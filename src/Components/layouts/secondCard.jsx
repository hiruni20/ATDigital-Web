    ...
    <div className="min-h-screen w-full p-5 text-center bg-white mx-auto">
      ...
      <div className="min-h-screen flex bg-white">
        <div className="p-8 flex flex-col md:flex-row justify-between items-center w-full">
          <div className="w-full md:w-1/2 pr-8 mb-8 md:mb-0"> {/* Adjusted margin-bottom (mb) for smaller screens */}
          ...
          <div className="w-full md:w-1/2 text-left">
            ...
            <button className="w-full md:w-1/2 bg-orange-500 text-white font-small px-4 py-2 rounded hover:bg-purple cursor-pointer">
              LEARN MORE
            </button>
          </div>
        </div>
